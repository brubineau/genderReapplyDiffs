...
1. Model Code
   ...
   + [Illustration of solution equivalence](#illustration-of-solution-equivalence)
     - [A1. Numeric and Analytic Solution Equivalence - Distribution of Differences](#a1-numeric-and-analytic-solution-equivalence-distribution-of-differences)
     - [A2. Numeric and Analytic Solution Equivalence - Differences by Model Time](#a2-numeric-and-analytic-solution-equivalence-differences-by-model-time) 
   + [Time to equilibrium](#time-to-equilibrium)
     - [A3. Time to Equilibrium - Model Time 0 to 10,000](#a3-time-to-equilibrium-model-time-0-to-10000)
     - [A4. Time to Equilibrium - Model Time 0 to 1,000](#a4-time-to-equilibrium-model-time-0-to-1000)
...
3. Analysis for Proposition 1 Parameter Values
     - [A5. Effects of Individual Parameters in Real World Subset of Parameter Space](#a5-effects-of-individual-parameters-in-real-world-subset-of-parameter-space)
     - [A6. Effects of Individual Parameters When r>0.80, 0.40<b<0.99, g>1.3](#a6-effects-of-individual-parameters-when-r-0-80-0-40-b-0-99-g-1-3)
4. Consideration of model variations
   + [Collecting selected applicants](#modeling-stocks-of-selected-applicants)
     - [A7. Convergence of Equilibria - Model Differences by Model Time](#a7-convergence-of-equilibria-model-differences-by-model-time)
...
```
### A1. Numeric and Analytic Solution Equivalence - Distribution of Differences
```{r}
plot(density(diff1k[2,which(diff1k[4,]!=0)],na.rm=T),
     main="Difference between numeric and analytical solutions\n
     for randomly-selected points in parameter space") # note almost all results are indistinguishable from zero
```
### A2. Numeric and Analytic Solution Equivalence - Differences by Model Time
```{r}
...
```
### A3. Time to Equilibrium - Model Time 0 to 10,000
```{r}
...
```
### A4. Time to Equilibrium - Model Time 0 to 1,000
```{r}
...
### A5. Effects of Individual Parameters in Real World Subset of Parameter Space
...
rowMeans(replicate(1000000,prop1Sbe(b=runif(1,min=0.54,max=0.88))))
...
### A7. Effects of Individual Parameters When r>0.80, 0.40<b<0.99, g>1.3
Effects of model parameters when sampling 10,000 random points in the parameter space for each x-axis value of the parameter in the figure. The observed parameter values from the three cases are given in each panel. The left column of graphs plot parameter effects in terms of the average sex bias equivalent odds ratio favoring men in selection ($OR_M$). The right column of graphs plot parameter effects in terms of the portion of sampled parameter space yielding substantive ($OR_M \geq 1.2$) segregating effects. 
