...
cases <- data.frame(caseID=c(   "ExecSearch",    "CrowdFund",    "Patenting"),
                    ...
                    p=c(                0.16,           0.29,          0.088), # women's share among applicants
                    ...
                    pr.reapply.w=c( 1-0.3558,        0.10854,         0.5305)) # estimates of reapplication probabilities for women
...
# returns the final women's share of all selected men and women.
...
plot(x=c(500,1000,10000,100000),
     ...
     xlab="Model Time",
     ylab="Difference between Women's share of selected\n
     and calculated women's share of applicant pool at equilibrium")
...
### Finding: After examining several empirical contexts where differential reapplication behavior by the quality of the applicant could be observed, we find no such quality effects on reapplication behaviors.
